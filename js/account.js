...
function paginationAccount(result) {
    ...
    $('#pagination-account').html(`<a title="Previous" href = "javascript:void(0)" onclick="toAccountPage(${activeNumber > 1 ? activeNumber - 1 : activeNumber})"><i class="fa-solid fa-chevron-left"></i></a>`);
    ...
    $('#pagination-account').append(`<a href = "javascript:void(0)" title="Next" onclick="toAccountPage(${activeNumber < result.totalPages ? activeNumber + 1 : activeNumber})"><i class="fa-solid fa-chevron-right"></i></a>`);
